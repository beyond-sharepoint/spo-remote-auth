...
module.exports = (function () {
    ...
    let ensureContextInfo = function* (tenantDomain, rtFa, fedAuth, currentContextInfo) {
        ...
        return yield this.obtainContextInfoAsync(tenantDomain, rtFa, fedAuth);
    };
    ...
    let authenticate = function* (tenantDomain, username, password) {
        ...
        let securityToken = yield self.obtainSecurityTokenAsync(tenantDomain, username, password);

        let accessTokenResult = yield self.obtainAccessTokenAsync(tenantDomain, securityToken);

        let contextInfoResult = yield self.obtainContextInfoAsync(tenantDomain, accessTokenResult.rtFa, accessTokenResult.FedAuth);
        ...
        return {
            ...
            ensureContextInfo: function () {
                contextInfoResult = ensureContextInfo.call(self, tenantDomain, accessTokenResult.rtFa, accessTokenResult.FedAuth, contextInfoResult);
