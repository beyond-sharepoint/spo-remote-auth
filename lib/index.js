...
module.exports = (function () {
    ...
    let obtainSecurityToken = function* (tenantDomain, username, password) {
        ...
        let responseData = xmlParser.toJson(stsResponse.body, { object: true });
        ...
        return _.get(responseData, "S:Envelope.S:Body.wst:RequestSecurityTokenResponse.wst:RequestedSecurityToken.wsse:BinarySecurityToken.$t");
    };
    ...
    let authenticate = function* (tenantDomain, username, password) {
        ...
        let defaultSPRequest = request.defaults({
            ...
            headers: {
                "Accept": "application/json;odata=verbose",
                "Content-Type": "application/json;odata=verbose",
                "X-Request-Digest": contextInfoResult.FormDigestValue,
